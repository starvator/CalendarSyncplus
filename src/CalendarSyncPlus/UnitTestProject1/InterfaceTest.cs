...
using CalendarSyncPlus.Presentation.Services;
...
namespace Refactoring
{
    ...
    public class InterfaceTest
    {
        ...
        public void TestTaskInterfaceHierarchy()
        {
            ...
            ITaskService googleTask = new GoogleTaskService(new AccountAuthenticationService(new ApplicationLogger(), new MessageService(new CalendarSyncPlus.Presentation.Views.Main.ShellView())), new ApplicationLogger());
        }
        ...
        public void TestCalendarInterfaceHierarchy()
        {
            ...
            ICalendarService googleCalendar = new GoogleCalendarService(new AccountAuthenticationService(new ApplicationLogger(), new MessageService(new CalendarSyncPlus.Presentation.Views.Main.ShellView())), new ApplicationLogger());
        }
